...
export class World
{
	...
	constructor(worldScenePath?: any)
	{
		...
		if (worldScenePath !== undefined)
		{
			...
			loadingManager.onFinishedCallback = () =>
			{
				...
				Swal.fire({
					title: 'Bienvenue sur Sketchbook!',
					text: "Soyez libre d'explorer le monde et d'intéragir avec les véhicules disponibles. Il y a aussi des scénarios préparer dans le menu à en haut à droite",
	...
	public update(timeStep: number, unscaledTimeStep: number): void
	{
		...
		//console.log('test du timestep: ',timeStep)
				...
				if (child.userData.hasOwnProperty('data'))
				{
					if (child.userData.data === 'physics')
					{
						if (child.userData.hasOwnProperty('type')) 
						{
							...
							{
								//console.log("setting collision of ", child)
